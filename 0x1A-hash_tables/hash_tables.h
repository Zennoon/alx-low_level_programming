 ...
 * @key: The key, string. It is unique in the hash table
 * @value: The value corresponding to a key
 * @next: Pointer to the next node of the list (in the array)
 ...
 * list because we want our hash table to use a Chaining collision handling
